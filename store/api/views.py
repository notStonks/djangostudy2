...
class ProductModelSetView(ModelViewSet):
    ...
    def get_permissions(self):
        ...
        return super(ProductModelSetView, self).get_permissions()


class BasketItemModelSetView(ModelViewSet):
    ...
    def get_queryset(self):
        queryset = super(BasketItemModelSetView, self).get_queryset()
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            basket_item, is_created = BasketItem.create_or_update(product_id, self.request.user)
